export const resetPasswordLinkTemplate = (resetLink: string) => `<html>
<head>
  <meta charset="UTF-8">
                ...
                <tr>
                  <td>      
                    <div style="text-align: center; margin-bottom: 20px;">
                      <h2 style="color: #001044; font-size: 24px; font-weight: 700; margin: 0;">Reset password link</h2>
                    </div>
                    <div style="text-align: center; margin-bottom: 20px;">
                      <p style="color: #001044; font-size: 14px; font-weight: 400; margin: 0;">Please click the button below to reset your password.</p>
                    </div>
                  </td>
                </tr>
                <tr>
                    ...
                    <table border="0" cellspacing="0" cellpadding="0" style="margin-top: 20px;">
                      <tr>
                        <td align="center" bgcolor="#297afc" style="border-radius: 20px;">
                          <a href="${resetLink}" style="display: inline-block; padding: 12px 24px; font-size: 16px; color: #ffffff; text-decoration: none; font-weight: 700;">Reset Now</a>
                        </td>
                      </tr>
                    </table>
                  </td>
